...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /**
     * @return this request's {@link mobpair.com.mylibrary.Response.ErrorListener}.
     */
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.mylibrary.Request<?> setRetryPolicy(RetryPolicy retryPolicy) {
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.mylibrary.Request<?> setRequestQueue(RequestQueue requestQueue) {
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.mylibrary.Request<?> setSequence(int sequence) {
        mSequence = sequence;
        return this;
    }
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.mylibrary.Request<?> setCacheEntry(mobpair.com.mylibrary.Cache.Entry entry) {
        mCacheEntry = entry;
        return this;
    }
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.mylibrary.Request<?> setShouldCache(boolean shouldCache) {
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.mylibrary.Request<?> setShouldRetryServerErrors(boolean shouldRetryServerErrors) {
     ...
     */
    @Override
    public int compareTo(mobpair.com.mylibrary.Request<T> other) {
