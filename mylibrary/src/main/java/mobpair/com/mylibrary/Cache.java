...
public interface Cache {
    ...
    class Entry {
         ...
         * headers if the {@link mobpair.com.mylibrary.Cache} implementation supports it.
         */
        public Map<String, String> responseHeaders = Collections.emptyMap();

        /**
         * All response headers. May be null depending on the {@link mobpair.com.mylibrary.Cache} implementation. Should
