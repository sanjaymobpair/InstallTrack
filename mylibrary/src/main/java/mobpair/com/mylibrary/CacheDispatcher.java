...
public class CacheDispatcher extends Thread {
    ...
    public CacheDispatcher(
            ...
            mobpair.com.mylibrary.Cache cache, ResponseDelivery delivery) {
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        private final mobpair.com.mylibrary.CacheDispatcher mCacheDispatcher;

        WaitingRequestManager(mobpair.com.mylibrary.CacheDispatcher cacheDispatcher) {
